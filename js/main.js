...
function MQTTconnect() {
  ...
  // var user_name="loraroot";
  // var password="loraroot";
  console.log("clean= "+clean_sessions);

  var MQTTbroker = 'mqtt.nextel.es';
  var MQTTport = 1884;
...
function initMap() {
  // var nextel = {lat: 43.295462, lng: -2.863638};
  var nextel = new google.maps.LatLng(43.295462, -2.863638);
  console.log(nextel);
